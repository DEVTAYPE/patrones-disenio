...
class PokemonCollection {
  ...
  *getPokemons(): Generator<Pokemon> {
    for (const pokemon of this.pokemons) {
      yield pokemon; // Función generadora para iterar sobre los pokemons
    }
  }

  *[Symbol.iterator](): Generator<Pokemon> {
    yield* this.pokemons; // Permite usar for...of directamente en la colección
  }
}
